...
/* ADD NEW SITE */
export const SITE_GET_DATA = "SITE_GET_DATA";
export const SITE_GOT_DATA = "SITE_GOT_DATA";
export const SITE_GET_DATA_ERROR = "SITE_GET_DATA_ERROR";

/* SITE VIEWER */
export const SITE_GET_WEATHER = "SITE_GET_WEATHER";
export const SITE_GOT_WEATHER = "SITE_GOT_WEATHER";
export const SITE_GET_WEATHER_ERROR = "SITE_GET_WEATHER_ERROR";

//locationKey
export const SITE_GET_WEATHER_LOCKEY = "SITE_GET_WEATHER_LOCKEY";
export const SITE_GOT_WEATHER_LOCKEY = "SITE_GOT_WEATHER_LOCKEY";
export const SITE_GET_WEATHER_ERROR_LOCKEY = "SITE_GET_WEATHER_ERROR_LOCKEY";

/* Azure Blob */
export const AZURE_CREATE_CONTAINER = "AZURE_CREATE_CONTAINER";
export const AZURE_CONTAINER_LIST = "AZURE_CONTAINER_LIST";
export const AZURE_CREATE_BLOB = "AZURE_CREATE_BLOB";
